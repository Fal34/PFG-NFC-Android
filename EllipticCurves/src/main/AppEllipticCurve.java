...
public class AppEllipticCurve implements AppEllipticCurveI{
    ...
    public static final int DEFAULT_REDUCTION_POLYNOMIAL = 2;
    public static final int DEFAULT_COFACTOR_VALUE = 2;
    public static final int TARGET_NFCTAG_SIZE = 137;
    public static final int TARGET_NFCTAG_OFFSET = 7;
    ...
    @Override
    public X9ECParameters loadEC(String curveName, BigInteger k) throws IllegalArgumentException {
